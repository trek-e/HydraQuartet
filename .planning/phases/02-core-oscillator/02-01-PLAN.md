...
<task type="auto">
  ...
  <action>
Add per-voice state structures to TriaxVCO class for antialiasing.
...
**Add per-voice state struct BEFORE the TriaxVCO struct:**
```cpp
struct VCO1Voice {
...
**Add member variable to TriaxVCO (after the phase[4] array):**
```cpp
